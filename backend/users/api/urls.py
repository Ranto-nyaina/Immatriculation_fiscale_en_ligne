...
urlpatterns = [
    ...
    path(
        'transactions/',
        TransactionSearchView.as_view(),
        name='transaction-search'
    ),

    path(
        'histogramme/',
        HistogrammeAPIView.as_view(),
        name='histogramme'
    ),

    path(
        'register/',
        RegisterContribuable.as_view(),
        name='register_contribuable'
    ),
    ...
    path(
        'AdminMessages/',
        MessagesAdminList.as_view(),
        name='messages_admin_list'
    ),
    ...
    path(
        'civisme_fiscale/',
        CivismeFiscaleList.as_view(),
        name='civisme_fiscale_list'
    ),
